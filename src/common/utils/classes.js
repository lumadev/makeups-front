const inputClass =
  ...
  'focus:ring-1 focus:ring-gray-200 focus:border-gray-300 outline-none transition-colors duration-150 block w-full p-2.5 ' +
  'dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 ' +
  'dark:text-white dark:focus:ring-gray-700 dark:focus:border-gray-600'
