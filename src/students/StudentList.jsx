      ...
      <div classNameName="flex flex-col">
        <div classNameName="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
          <div classNameName="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
            <div classNameName="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
              <table classNameName="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
